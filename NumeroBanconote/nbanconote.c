/*Scrivere un programma che chiede all'utente di inserire un ammontare intero in euro e mostra, secondo lo schema seguente, come pagare usando
 il minor numero di carte da 1, 5, 10, 20 euro.*/
